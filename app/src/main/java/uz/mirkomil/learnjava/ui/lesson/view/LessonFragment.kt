...
class LessonFragment : BaseFragment(R.layout.fragment_lesson), LessonView {
    ...
    fun getTestAll() : ArrayList<Test>{
        ...
        data.add(Test(52,2,  2,"public class Main {\n" +
                "            int x;\n" +
                "\n" +
                "            public static void main(String[] args) {\n" +
                "                Main myObj = new Main();\n" +
        ...
        data.add(Test(52,2,  3,"Constuctor nima?", "class nomidagi funksiya", "Massiv", "class nomidagi method","class nomidagi funksiya"))
        data.add(Test(52,2,  3,"Constuctor necha xil turi mavjud", "1", "2", "3","2"))
        data.add(Test(52,2,  3,"Javada konstruktor yaratish qoidalari:", "xoxlagan nom bilan yaratish mumkin", "boshqa funksiyalar bilan bir xil bo’lishi kerak", "class nomi bilan bir xil bo’lishi kerak","class nomi bilan bir xil bo’lishi kerak"))
        data.add(Test(52,2,  3,"Constuctor 2 turi bular qaysilar..", "Argumentli,funksiyali", "methodli,argumentsiz", "Argumentsiz konstruktorlar, Parametrlik konstruktorlar","Argumentsiz konstruktorlar, Parametrlik konstruktorlar"))
        data.add(Test(52,2,  3,"bu yerda consuctor qaysi?\n" +
                "        1.\t class Bike1 {\n" +
                "            2.\n" +
                "            3.\tBike1() {\n" +
                ...
                "            12.\n" +
                "        }", "B", "Bike1", "Bike","Bike1"))
        data.add(Test(52,2,  3,"Constuctor majburiy bo’lishi mumkinmi ?", "xa", "yuq", "classga bogliq","xa"))
        data.add(Test(52,2,  3,"Constuctor qiymat qabul qiladimi?", "ha", "yuq", "hammasi tugri","ha"))

        data.add(Test(52,2,  4,"Java-da inkapsulatsiya – bu?", "ma'lumotlar (o'zgaruvchilar) va ma'lumotlarga (usullarga) ta'sir qiluvchi kodni bir butunga birlashtirish mexanizmi", "belgilar va ma'lumotlarga (usullarga) ta'sir qiluvchi kodni bir butunga birlashtirish mexanizmi", "ma'lumotlarga (usullarga) ta'sir qiluvchi kodni bir butunga birlashtirish mexanizmi","ma'lumotlar (o'zgaruvchilar) va ma'lumotlarga (usullarga) ta'sir qiluvchi kodni bir butunga birlashtirish mexanizmi"))
        data.add(Test(52,2,  4,"Javada inkapsulatsiya qaysilar", "private,massiv", "private,public,protected", "public,method,protected","private,public,protected"))
        data.add(Test(52,2,  4,"public vazifasi nima?", "malumotlarni ochiq holda hamma foydalanishini kafolatlaydi", "Malumotlarni yopiq olda hech kim foydalana olmasligini kafolatlaydi", "malum bir yopiq va malum bir yopiq holda kafolatlaydi","malumotlarni ochiq holda hamma foydalanishini kafolatlaydi"))
        data.add(Test(52,2,  4,"private vazifasi nima?", "malumotlarni ochiq holda hamma foydalanishini kafolatlaydi", "Malumotlarni yopiq olda hech kim foydalana olmasligini kafolatlaydi", "malum bir yopiq va malum bir yopiq holda kafolatlaydi","Malumotlarni yopiq olda hech kim foydalana olmasligini kafolatlaydi"))
        data.add(Test(52,2,  4,"protected vazifasi nima?", "malumotlarni ochiq holda hamma foydalanishini kafolatlaydi", "Malumotlarni yopiq olda hech kim foydalana olmasligini kafolatlaydi", "malum bir yopiq va malum bir yopiq holda kafolatlaydi","malum bir yopiq va malum bir yopiq holda kafolatlaydi"))
        data.add(Test(52,2,  4,"Public classlarda ishlatiladimi ?", "xa", "yuq", "bilmayman","xa"))
        data.add(Test(52,2,  4,"Protected classlarda ishlatiladimi ?", "xa", "yuq", "bilmayman","xa"))

        data.add(Test(52,2,  5,"Metodni bekor qilish to'g'rik ko'rsatilgan javobni korsating", "Argumentlar ro'yxati bekor qilingan usul bilan bir xil bo'lishi kerak.", "Argumentlar ro'yxati bekor qilingan usul bilan xar xil bo'lishi kerak.", "Argumentlar ro'yxati bekor qilingan usul bilan ozgina xil bo'lishi kerak.","Argumentlar ro'yxati bekor qilingan usul bilan bir xil bo'lishi kerak."))
        data.add(Test(52,2,  5,"Metodni bekor qilish to'g'rik ko'rsatilgan javobni korsating", "Qaytish turi bir xil yoki superklassda asl bekor qilingan usulda e'lon qilingan qaytish turining pastki turi bo'lishi kerak.", "Argumentlar ro'yxati bekor qilingan usul bilan xar xil bo'lishi kerak.", "Argumentlar ro'yxati bekor qilingan usul bilan ozgina xil bo'lishi kerak.","Qaytish turi bir xil yoki superklassda asl bekor qilingan usulda e'lon qilingan qaytish turining pastki turi bo'lishi kerak."))
        data.add(Test(52,2,  5,"Ortiqcha usulning superklass versiyasini chaqirishda qanday kalit s’zdan foydalaniladi", "final", "", "",""))
        data.add(Test(52,2,  5,"", "", "", "",""))
        ...
        b.move
        c. Dogs can walk and run
        5. Metodni bekor qilish qoidalarida konstructorni bekor qilish mumkinmi ?
        a.yuq
        b.xa
        c. bilmadim
        6. Metodni bekor qilish qoidalarida Final deb e'lon qilingan usulni bekor qilib bo’ladimi
        a.xa
        b.yuq
        c. bilmayman

        7. Metodni bekor qilish qoidalarida Boshqa paketdagi subklass faqat ommaviy yoki himoyalangan deb e'lon qilingan yakuniy bo'lmagan usullarni bekor qilishi mumkinmi.
        Xa
        Yuq
        bilmayman
